...
/**
 * Created by dave on 3/5/17.
 */
public class RandomStudent extends Student {
    ...
    public RandomStudent() {
        this.name = randomChoice(givenNames) + " " + randomChoice(surnames);
        this.id = Integer.toString(rand.nextInt(999999));
    }
